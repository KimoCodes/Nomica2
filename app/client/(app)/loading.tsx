        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
          <div className="mx-auto max-w-7xl space-y-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <div className="h-64 animate-slide-up stagger-5 rounded-2xl border border-border/50 bg-card skeleton-shimmer lg:col-span-2" />
              <div className="h-64 animate-slide-up stagger-6 rounded-2xl border border-border/50 bg-card skeleton-shimmer" />
            </div>
          </div>
        </main>
      </div>

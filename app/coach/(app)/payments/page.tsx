...
import { getPaymentRequestsForCoach } from "@/server/services/payment-request.service";
...
export default async function CoachPaymentsPage() {
  ...
  const paymentRequests = await getPaymentRequestsForCoach(session.user.id);
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            Review payment submissions from your clients.
          </p>
        </div>
        ...
        <Card className="animate-slide-up stagger-3">
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-base">Client Payment Requests</CardTitle>
            ...
            {paymentRequests.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-xl border border-dashed py-12 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Payment requests from your clients will appear here.
                </p>
              </div>
            ) : (
              <Table>
